            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="card mb-3">
                        <form method="post" enctype="multipart/form-data" action="<?=base_url();?>admin/quan_tri_tin_tuc/thuc_hien_sua">
                        <!-- Thếm mới tin tức ở đây -->
                            <div class="position-relative form-group">
                                <label for="exampleAddress2" class="">Loại tin tức</label>
                                <select name="txtLoaiTinTuc">
                                <?php 
                                foreach ($loai_tin_tuc as $loai_tin) {
                                    if($loai_tin->id==$tin_tuc->loai_tin_id) {
                                ;?>
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="txtTieuDe" type="text" class="form-control" value="<?=$tin_tuc->tieu_de;?>">
                            </div>
                            <div class="position-relative form-group">
                                <label for="exampleAddress2" class="">Ảnh minh họa</label>
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="txtMoTa" type="text" class="form-control" value="<?=$tin_tuc->mo_ta;?>">
                            </div>
                            <div class="position-relative form-group">
                                <label for="exampleAddress2" class="">Nội dung</label>
                                <input name="txtNoiDung" type="text" class="form-control" value="<?=$tin_tuc->noi_dung;?>">
                            </div>
                            <button class="btn btn-primary">Submit</button>
                            <input name="txtID" type="hidden" class="form-control" value="<?=$tin_tuc->id;?>">
                        </form>
                    </div>
                </div>
